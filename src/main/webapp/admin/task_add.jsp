...
<body>
	...
	<table id="taskAdd" align="center" width="1200px;" border="1px"
		...
		<tr>
			...
			<td><input type="text" id="task_name" placeholder="任务名称"
				value="测试任务" /><br /></td>
		</tr>
		<tr>
			<td>抽取模板ID:</td>
			<td><input type="text" id="template_id" placeholder="模板ID，默认为1"
				value="1" /></td>
		</tr>
		<tr>
			<td>下载线程数:</td>
			<td><input type="text" id="download_thread_num"
				placeholder="下载线程数" value="1" /></td>
		</tr>
		<tr>
			<td>数据存储表名:</td>
			<td><input type="text" id="insert_db_table_name"
				placeholder="使用的数据库表" value="dytt_movie_dir" /></td>
		</tr>
		<tr>
			<td>是否使用数据库中URL:</td>
		...
		<tr>
			...
			<td><textarea id="urls_or_sql" rows="10" cols="100"
					placeholder='数据库查询URL的SQL语句或以","分隔的URL列表'>http://www.ygdy8.net/html/gndy/dyzz/list_23_1.html,http://www.ygdy8.net/html/gndy/dyzz/list_23_2.html</textarea></td>
		</tr>
		<tr>
			<td>描述</td>
			<td><textarea id="task_describtion" rows="5" cols="100"
					placeholder='任务描述'>这里填写任务描述，简介任务内容</textarea></td>
		</tr>
		<tr>
			<td></td>
