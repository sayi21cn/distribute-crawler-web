package xu.main.java.distribute_crawler_web.configure;

public class CrawlerWebConf {

	// 上传文件保存目录
	public static final String FILE_UPLOAD_SAVE_DIR = "";

	// 处理结果文件保存目录
	public static final String PROCESSED_FILE_DIR = "";

	public static final String JDBC_DB_NAME = "jdbc/movie_crawler";
